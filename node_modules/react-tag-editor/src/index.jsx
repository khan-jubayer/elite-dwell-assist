	...
	renderTag: function(props, tag, index) {
		...
		if (tagClearTool){
			if (typeof tagClearTool == 'function'){
				...
				tool = <span style={props.tagClearToolStyle} onClick={this.onTagClearClick.bind(this, props, tag, index)}>✖</span>
			}
		}
		...
		return <span key={index} style={tagStyle} onMouseDown={preventDefault} onClick={this.onTagClick.bind(this, props, tag, index)}>
			{tag}
			{tool}
		</span>
	},
