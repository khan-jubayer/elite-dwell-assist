...
const TVBill = () => {
  ...
  const pdfGenerate = () => {
    ...
    const tableRows = [
      ["TV Sound Problem", "1000", soundProblemCount.toString()],
      ["TV Power Supply Servicing", "1000", powerSupplyProblemCount.toString()],
      ["TV Mounting", "1000", mountingCount.toString()],
      ["TV Display Servicing", "1000", displayCount.toString()],
    ];
  ...
  const handleServiceSelect = () => {
    ...
    if (soundProblemCount > 0) {
      updatedServices.push({
        name: "TV Sound Problem",
        count: soundProblemCount,
      });
    }
    if (powerSupplyProblemCount > 0) {
      updatedServices.push({
        name: "TV Power Supply Problem",
        count: powerSupplyProblemCount,
      });
    }
    if (displayCount > 0) {
      updatedServices.push({ name: "TV Display", count: displayCount });
    }
    if (mountingCount > 0) {
        ...
        <div className="absolute  right-28 w-96 text-center text-base">
          ...
          <div className="absolute top-[333px] left-[27px] w-[376px] h-[137px]">
            ...
            <div className="absolute h-8 w-24 bottom-2 left-28 text-sm">
              ...
              <button
                ...
                id="tv_mounting_plus"
                onClick={() => {
                  setMountingCount(mountingCount + 1);
                  handleServiceSelect("TV Mounting");
                }}
              >
                <span className="text-2xl">+</span>
          ...
          <div className="absolute top-[35px] left-[27px] w-[376px] h-[137px]">
            ...
            <div className="absolute h-8 w-24 bottom-2 left-28 text-sm">
              ...
              <button
                ...
                id="tv_sound_plus"
                onClick={() => {
                  setSoundProblemCount(soundProblemCount + 1);
                  handleServiceSelect("TV Sound Problem");
                }}
              >
                <span className="text-2xl">+</span>
          ...
          <div className="absolute top-[485px] left-[27px] w-[376px] h-[137px]">
            ...
            <button
              ...
              id="cancel_button"
              onClick={() => {
                handleServiceSelect("TV Display");
                setDisplayCount(0);
              }}
            >
              <img
            ...
            <div className="absolute h-8 w-24 bottom-2 left-28 text-sm">
              <button
                ...
                id="tv_display_minus"
                onClick={() => {
                  setDisplayCount(Math.max(displayCount - 1, 0));
                  handleServiceSelect("TV Display");
                }}
              >
                <span className="text-2xl">-</span>
          ...
          <div className="text-left ml-16  text-xl font-medium">Services</div>
        </div>
      </div>
      <Footer />
    </div>
