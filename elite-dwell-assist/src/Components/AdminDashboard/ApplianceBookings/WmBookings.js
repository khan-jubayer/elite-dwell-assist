  ...
  const acknowledgeBooking = (booking) => {
    ...
    fetch("http://localhost:5000/acknowledgeBooking", {
      ...
      .then((data) => {
        ...
        toast.success("WM Booking acknowledged", {
          position: toast.POSITION.TOP_CENTER,
        });
      })
      .catch((error) => {
        console.error("Error acknowledging WM booking:", error);
      });
  };
  ...
  return (
    <div>
      <h2 className="text-3xl text-blue-900 font-bold mb-6">
        Booking Notifications For Washing Machine
      </h2>
